 ...
 */
public class LAutoLRLCmdGroup extends CommandGroup {

    public LAutoLRLCmdGroup() {
    	
    	DriverStation.reportWarning("L-Autonomous Procedure LRL initiated.", false);
    	...
    	DriverStation.reportWarning("L-Autonomous Procedure LRL complete.", false);
