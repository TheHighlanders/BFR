 ...
 */
public class CAutoRightCmdGroup extends CommandGroup {

    public CAutoRightCmdGroup() {
        
    	DriverStation.reportWarning("C-Autonomous Procedure RIGHT initiated.", false);
    	...
    	DriverStation.reportWarning("C-Autonomous Procedure RIGHT complete.", false);
